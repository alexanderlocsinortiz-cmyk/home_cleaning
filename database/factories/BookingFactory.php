...
class BookingFactory extends Factory
{
    ...
    public function definition(): array
    {
        return [
            ...
            'property_fee' => $this->faker->randomFloat(2, 0, 500),
            'rooms_fee' => $this->faker->randomFloat(2, 0, 150),
            'bathrooms_fee' => $this->faker->randomFloat(2, 0, 150),
            'floor_area_fee' => $this->faker->randomFloat(2, 0, 200),
            'add_ons_fee' => $this->faker->randomFloat(2, 0, 150),
