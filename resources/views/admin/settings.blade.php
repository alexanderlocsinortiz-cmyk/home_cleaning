                        ...
                        <div class="mt-4 grid gap-3">
                            ...
                            <div class="grid gap-3 sm:grid-cols-2">
                                <label class="block">
                                    ...
                                    <div class="relative mt-2">
                                        <input type="password" name="admin_new_password" autocomplete="new-password" class="h-11 w-full rounded-xl border border-slate-200 bg-white px-3 pr-11 text-sm outline-none transition focus:border-blue-400 focus:ring-4 focus:ring-blue-100">
                                ...
                                <label class="block">
                                    ...
                                    <div class="relative mt-2">
                                        <input type="password" name="admin_new_password_confirmation" autocomplete="new-password" class="h-11 w-full rounded-xl border border-slate-200 bg-white px-3 pr-11 text-sm outline-none transition focus:border-blue-400 focus:ring-4 focus:ring-blue-100">
