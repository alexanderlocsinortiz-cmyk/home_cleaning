...
<body>
    <div class="container">
        <div class="header">
            ...
            <p style="margin:5px 0 0 0; opacity:0.9;">Your cleaning service has started</p>
        </div>
        <div class="body">
            <p>Hi <strong>{{ $booking->user->first_name }}</strong>,</p>
            <p>Your cleaning service is now <strong>in progress</strong>! Our staff is currently at your location.</p>
            ...
            <div class="booking-box">
                ...
                <div class="row">
                    ...
                    <span class="value">{{ $booking->staff->first_name ?? 'N/A' }} {{ $booking->staff->last_name ?? '' }}</span>
                </div>
            ...
            <p style="color:#64748b; font-size:14px;">You will receive another email once the service is completed.</p>
        </div>
        <div class="footer">
