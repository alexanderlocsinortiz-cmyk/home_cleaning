...
<head>
    ...
    <title>@yield('title', 'Staff') - {{ $siteSettings->website_name }} Staff</title>
...
<body class="admin-ui staff-ui bg-slate-50 flex min-h-screen overflow-x-hidden">
    ...
    <aside class="admin-sidebar fixed left-0 top-0 z-50 flex min-h-screen w-64 flex-col bg-blue-800" id="staff-sidebar">
        ...
        <nav class="py-4 flex-1">
            ...
            <a href="{{ route('staff.dashboard') }}" class="flex items-center gap-3 border-r-4 border-transparent px-6 py-3 text-slate-300 transition-all hover:border-blue-500 hover:bg-blue-500/10 hover:text-white {{ request()->routeIs('staff.dashboard') ? 'border-blue-500 bg-blue-500/10 text-white' : '' }}">
                <i class="fas fa-tachometer-alt w-5 text-center"></i> Dashboard
            </a>
            <div class="px-6 py-2 text-xs font-semibold text-slate-500 uppercase tracking-wider mt-4">Operations</div>
            <a href="{{ route('staff.performance') }}" class="flex items-center gap-3 border-r-4 border-transparent px-6 py-3 text-slate-300 transition-all hover:border-blue-500 hover:bg-blue-500/10 hover:text-white {{ request()->routeIs('staff.performance') ? 'border-blue-500 bg-blue-500/10 text-white' : '' }}">
                <i class="fas fa-chart-line w-5 text-center"></i> My Performance
            </a>
            <a href="{{ route('staff.schedule') }}" class="flex items-center gap-3 border-r-4 border-transparent px-6 py-3 text-slate-300 transition-all hover:border-blue-500 hover:bg-blue-500/10 hover:text-white {{ request()->routeIs('staff.schedule') ? 'border-blue-500 bg-blue-500/10 text-white' : '' }}">
                <i class="fas fa-calendar-alt w-5 text-center"></i> Schedule
            </a>
            <a href="{{ route('staff.bookings') }}" class="flex items-center gap-3 border-r-4 border-transparent px-6 py-3 text-slate-300 transition-all hover:border-blue-500 hover:bg-blue-500/10 hover:text-white {{ request()->routeIs('staff.bookings') ? 'border-blue-500 bg-blue-500/10 text-white' : '' }}">
                <i class="fas fa-calendar-check w-5 text-center"></i> My Bookings
            </a>
            <a href="{{ route('staff.service-areas') }}" class="flex items-center gap-3 border-r-4 border-transparent px-6 py-3 text-slate-300 transition-all hover:border-blue-500 hover:bg-blue-500/10 hover:text-white {{ request()->routeIs('staff.service-areas') ? 'border-blue-500 bg-blue-500/10 text-white' : '' }}">
                <i class="fas fa-map-marked-alt w-5 text-center"></i> Service Areas
            </a>
            <a href="{{ route('staff.profile') }}" class="flex items-center gap-3 border-r-4 border-transparent px-6 py-3 text-slate-300 transition-all hover:border-blue-500 hover:bg-blue-500/10 hover:text-white {{ request()->routeIs('staff.profile') ? 'border-blue-500 bg-blue-500/10 text-white' : '' }}">
    ...
    <div class="admin-main ml-64 flex-1 min-w-0 overflow-x-hidden flex flex-col min-h-screen">
        ...
        <div class="admin-content min-w-0 overflow-x-hidden flex-1 bg-slate-50 p-0">
            @yield('content')
        </div>
    </div>
