                        ...
                        <div class="grid gap-4">
                            ...
                            <div class="grid gap-4 sm:grid-cols-2">
                                ...
                                <div>
                                    ...
                                    <input type="password" name="new_password" minlength="8" aria-describedby="profile-password-help" autocomplete="new-password" class="client-profile-input">
                                </div>
                            </div>
                            <div>
                                <label class="mb-2 block text-xs font-extrabold uppercase tracking-[0.16em] text-slate-500">Confirm New Password</label>
                                <input type="password" name="new_password_confirmation" minlength="8" autocomplete="new-password" class="client-profile-input">
                            </div>
