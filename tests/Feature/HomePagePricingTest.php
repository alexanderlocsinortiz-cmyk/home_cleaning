...
class HomePagePricingTest extends TestCase
{
    ...
    public function test_home_page_shows_instant_quote_pricing_component(): void
    {
        ...
        $response->assertSee('Build the price live while you compare packages, property size, and add-ons.', false);
        ...
        $response->assertSee('Office Basic', false);
        $response->assertSee('Office Standard', false);
        $response->assertSee('Office Deep', false);
        $response->assertSee('General/Regular', false);
        $response->assertSee('>Office</option>', false);
